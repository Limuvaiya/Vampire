...
root.I13N_config.location = "https:\u002F\u002Flogin.aol.com\u002Faccount\u002Fchallenge\u002Fpassword?display=narrow";
...
root.I13N_config.keys.test = "mbr-push-untrusted-ar,mbr-ahc-mobile-web,mbr-ahc-v2,mbr-fido-1fa-login,mbr-authenticator-2fa,mbr-rcscore-threshold,mbr-news-simplifiedreg,mbr-reg-phone-restriction,mbr-qr-comet-sdk";
root.mKeyPrefix = "password-challenge-";
root.challenge || (root.challenge = {});
root.challenge.servingStamp = 1632663038943;
...
root.isIOSDevice = false;
            ...
            window.mbrSendError = function (name, url) {
                (new Image()).src = '/account/js-reporting/?rid=1t2e2dpgl0tfu&crumb=' + encodeURIComponent('lCTGU5dM2jl') + '&message=' + encodeURIComponent(name) + '&url=' + encodeURIComponent(url);
            };
 ...
 <body class="bucket-mbr-push-untrusted-ar bucket-mbr-qr-comet-sdk"> 
  <script nonce="">
        (function(root) {
            var doc = document;
            if (root.isGoodJS) {
  ...
  <div id="login-body" class="loginish  puree-v2  grid    "> 
   <div class="mbr-login-hd" id="mbr-uh-hd"> 
    <a href="https://www.aol.co.uk/"> <img src="https://s.yimg.com/wm/assets/images/ns/aol-logo-black-v.0.0.2.png" alt="Aol" class="logo aol-en-GB" width="100" height=""> <img src="https://s.yimg.com/wm/assets/images/ybar/aol-logo-white-v0.0.4.png" alt="Aol" class="dark-mode-logo logo aol-en-GB" width="100" height=""> </a> 
   </div> 
  ...
  <noscript> 
   <img src="/account/js-reporting/?crumb=lCTGU5dM2jl&amp;message=javascript_not_enabled&amp;ref=%2Faccount%2Fchallenge%2Fpassword" height="0" width="0" style="visibility: hidden;"> 
  </noscript> 
  <script nonce="">
  ...
  <div class="mbr-legacy-device-bar" id="mbr-legacy-device-bar"> 
   ...
   <p class="mbr-legacy-device"> AOL works best with the latest versions of browsers. You're using an out-of-date or unsupported browser and some AOL features may not work properly. Please update your browser version now. <a href="">More&nbsp;info</a> </p> 
  </div> 
  <script nonce="">
        (function(root) {
            if (!root.isGoodJS) {
  ...
  <!-- fe17.member.bf1.yahoo.com - Sun Sep 26 2021 13:30:38 GMT+0000 (Coordinated Universal Time) - (0ms) -->
 </body>
</html>
